...
<head>
    ...
    <title>BASES DE DATOS 2-1 - BORRAR 1</title>
    <link rel="stylesheet" href="CSS/style.css">
</head>
<body>
    <h1>BASES DE DATOS 2-1 - BORRAR 1</h1>
    <ul>
        <li>
    ...
    try {
        ...
        if ($resultado->rowCount() != 0) {
            ...
            while ($row = $resultado->fetch()){
                echo "<tr>";
                echo "<td><input type='checkbox' name='borrar[]' id='{$row["id"]}' value='{$row["id"]}'></td>";
            ...
            echo "<p>";
            echo '<input type="submit" value="Borrar registro" name="enviar">';
